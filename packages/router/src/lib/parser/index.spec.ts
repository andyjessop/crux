...
describe('parsing', () => {
  describe('path', () => {
    ...
    test('fail 2', () => {
      expect(() => parse('noleadingslash')).toThrow('Must start with /');
    });
  ...
  describe('query', () => {
    ...
    test('optional params 2', () => {
      expect(parse('/foo?lorem?=:lorem')('http://localhost/foo')).toEqual({
        lorem: null,
      });
    });
    ...
    test('multiple param 2', () => {
      expect(parse('/foo?id*=:ids')('http://localhost/foo')).toEqual({});
    });

    test('multiple param 3', () => {
      expect(parse('/foo?id*=:ids')('http://localhost/foo?id=1')).toEqual({
        ids: ['1'],
      });
    });
...
describe('reversing', () => {
  describe('path', () => {
    ...
    test('happy 3', () => {
      expect(reverse('/user/:id<\\d+>/')({ id: '123' })).toEqual('/user/123');
    });

    test('fail 1', () => {
      expect(() => reverse('/:baz<(aa){2,3}>/')({})).toThrow('baz undefined');
    });
  });
  ...
  describe('query', () => {
    ...
    test('optional params 2', () => {
      expect(reverse('/foo?lorem?=:lorem')({})).toEqual('/foo');
    });
