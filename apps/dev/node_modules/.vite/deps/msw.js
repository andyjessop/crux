...
// optional-peer-dep:__vite-optional-peer-dep:graphql:msw
var require_vite_optional_peer_dep_graphql_msw = __commonJS({
  "optional-peer-dep:__vite-optional-peer-dep:graphql:msw"() {
    throw new Error(`Could not resolve "graphql" imported by "msw". Is it installed?`);
  }
});
...
Learn more about creating the Service Worker script: https://mswjs.io/docs/cli/init`));
    ...
    function parseQuery(query) {
      try {
        const { parse: parse3 } = require_vite_optional_peer_dep_graphql_msw();
