...
export function createUsersHttp() {
  ...
  return {
    ...
    getOne: (id: number): Promise<Response<User | undefined>> => new Promise((resolve, reject) => {
    ...
    put: (user: PutUser): Promise<Response<User | undefined>> => new Promise((resolve, reject) => {
